...
//////////////////////////////////////////////////////////////////////////////
PyExtensions::PyExtensions()
	: Py::ExtensionModule<PyExtensions>("pycimmb")
{
	...
	const Py::Module& pywbemMod)
{
	...
	g_pymod = new PyExtensions;
}

//////////////////////////////////////////////////////////////////////////////
// STATIC
PyExtensions*
PyExtensions::getModulePtr()
{
	return g_pymod;
}

...
{
	if (fname.subString(fname.size()-4)==".pyc")
	//if (fname.endsWith(".pyc"))
	{
		// remove the 'c' from .pyc
		String rfname = fname.subString(0, fname.size()-1);
		return rfname;
	}

	if (fname.subString(fname.size()-3)==".py")

...
void Object::validate()
{
	...
	if (! accepts (p))
	{
		...
		Pegasus::String s("CXX : Error creating object of type ");
...
Pegasus::String Object::as_string() const
{
    return static_cast<Pegasus::String>(str());
}
...
Char::Char(const Pegasus::String& v)
	:Object(PyString_FromStringAndSize (const_cast<char*>((const char *)v.getCString()),1), true)
{
	validate();
}
...
Char& Char::operator= (const Pegasus::String& v)
{
	set(PyString_FromStringAndSize (const_cast<char*>((const char *)v.getCString()),1), true);
	return *this;
}
...
Char::operator Pegasus::String () const
{
	return Pegasus::String(PyString_AsString (ptr()));
}
...
String::String(const Pegasus::String& v)
	: SeqBase<Char>(PyString_FromString(const_cast<char*>((const char *)v.getCString())), true )
{
	validate();
}
...
String::String( const Pegasus::String& v, size_t vsize )
	: SeqBase<Char>(PyString_FromStringAndSize( const_cast<char*>((const char *)v.getCString()),
...
String& String::operator= (const Pegasus::String& v)
{
	set(PyString_FromString(const_cast<char*>((const char *)v.getCString())), true);
	return *this;
}
...
Pegasus::String String::as_peg_string() const
{
	if(isUnicode())
	{
		...
		return Pegasus::String(PyString_AsString(s.ptr()));
		//throw TypeError("cannot return Pegasus::String from Unicode object");
	}
	else
	{
		return Pegasus::String(PyString_AsString(ptr()));
...
Pegasus::String Module::getFileName() const
{
	char *fname = PyModule_GetFilename(ptr());
	if (PyErr_Occurred())
	{
		PyErr_Clear();
		return Pegasus::String();
	}
	return Pegasus::String(fname);
}
...
{
    return (os << static_cast<Pegasus::String>(ob.str()));
}  
